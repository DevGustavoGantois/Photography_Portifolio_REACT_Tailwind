    ...
    <header className='fixed w-full px-[30px] lg:px-[100px] z-30 h-[100px] lg:h-[140px flex items-center'>
      <div className='flex flex-col lg:flex-row lg:items-center w-full justify-between'>
          ...
          <nav onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} className='hidden xl:flex gap-x-12 font-semibold'>
            ...
            <Link to={'/about'} className='text-[#696c6d] hover:text-primary transition'>Sobre</Link>
            <Link to={'/portifolio'} className='text-[#696c6d] hover:text-primary transition'>Portifólio</Link>
            <Link to={'/contact'} className='text-[#696c6d] hover:text-primary transition'>Contato</Link>
          </nav>
      </div>
       {/* Socials */}
       <Socials />
