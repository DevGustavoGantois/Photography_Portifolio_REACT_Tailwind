    ...
    <motion.section initial={{opacity: 0, y: '100%'}} animate={{opacity: 1, y: 0}} exit={{opacity: 0, y: '100%'}} transition={transition1} className='section'>
      <div className="container mx-auto h-full relative">
        <div className='flex flex-col lg:flex-row h-full items-center justify-start gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8'>
          <motion.div onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} initial={{opacity: 0, y: '-80%'}} animate={{opacity: 1, y: 0}} exit={{opacity: 0, y: '-80%'}} transition={transition1} className='flex flex-col lg:items-start'>
             <h1 className='h1'>Portifólio</h1>
             <p className='mb-12 max-w-sm'>
              Aqui estão alguns dos meus trabalhos de Fotógrafa e Film Maker.
              <b>Selecionei os melhores</b> projetos. 
              <br />
              <br/>
              Utilizei cenários que constratem a imagem dos contratantes dos meus serviços
              como fotógrafa.
             </p>
             <Link to={'/contact'} className='btn mb-[30px] mx-auto lg:mx-0'>Contrate-me</Link>
          </motion.div>
          <motion.div onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} className='grid grid-cols-2 lg:gap-2'>
